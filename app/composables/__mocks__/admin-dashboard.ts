...
import { mockAdminLovableOverview } from './admin-dashboard-lovable'
...
export const mockDashboardData: DashboardSummary = {
  lovable_overview: mockAdminLovableOverview,
  summary_stats: {
    active_projects: 124,
  ...
  recent_projects: [
    {
      id: '2841',
      project_number: 'PRJ-2841',
      name: 'Villa Al-Yasmin – Sanaa',
      name_key: 'admin.dashboard.lovable.demo_projects.villa_yasmin',
      city: "Sana'a",
      city_key: 'admin.dashboard.lovable.demo_cities.sanaa',
      client_name: 'Eng. Ahmed Al-Shami',
      client_name_key: 'admin.dashboard.lovable.demo_clients.ahmed_shami',
      status: 'active',
    ...
    {
      id: '2855',
      project_number: 'PRJ-2855',
      name: 'Coastal compound — Aden',
      name_key: 'admin.dashboard.lovable.demo_projects.coastal_aden',
      city: 'Aden',
      city_key: 'admin.dashboard.lovable.demo_cities.aden',
      client_name: 'North Construction Co.',
      client_name_key:
        'admin.dashboard.lovable.demo_clients.north_construction',
      status: 'waiting',
    ...
    {
      id: '2860',
      project_number: 'PRJ-2860',
      name: 'Medical clinic — Taiz',
      name_key: 'admin.dashboard.lovable.demo_projects.clinic_taiz',
      city: 'Taiz',
      city_key: 'admin.dashboard.lovable.demo_cities.taiz',
      client_name: 'Bayt Al-Masarra',
      client_name_key: 'admin.dashboard.lovable.demo_clients.bayt_masarra',
      status: 'under_review',
    ...
    {
      id: '2864',
      project_number: 'PRJ-2864',
      name: 'Warehouse retrofit',
      name_key: 'admin.dashboard.lovable.demo_projects.warehouse',
      city: 'Aden',
      city_key: 'admin.dashboard.lovable.demo_cities.aden',
      client_name: 'Logistics Partners LLC',
      client_name_key:
        'admin.dashboard.lovable.demo_clients.logistics_partners',
      status: 'active',
      milestones_completed: 0,
      milestones_total: 10,
  ...
  open_disputes: [
    {
      id: 'dispute-12',
      dispute_number: 'DSP-12',
      project_name: 'Villa Al-Yasmin – Sanaa',
      project_display_key: 'admin.dashboard.lovable.demo_projects.villa_yasmin',
      requester_name: '',
      requester_label_key: 'admin.dashboard.lovable.disputes.raised_by_owner',
      subject_key: 'admin.dashboard.lovable.disputes.subject_plumbing',
      subject: '',
      status: 'mediating',
    ...
    {
      id: 'dispute-9',
      dispute_number: 'DSP-09',
      project_name: 'Coastal compound — Aden',
      project_display_key: 'admin.dashboard.lovable.demo_projects.coastal_aden',
      requester_name: '',
      requester_label_key:
        'admin.dashboard.lovable.disputes.raised_by_contractor',
      subject_key: 'admin.dashboard.lovable.disputes.subject_payment_delay',
      subject: '',
      status: 'open',
