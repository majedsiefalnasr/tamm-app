...
- Name: tests/role-based-redirect.spec.ts >> Role-based redirect after login >> 403 page displays correctly in RTL (Arabic)
- Location: tests/role-based-redirect.spec.ts:145:3
