...
- Name: tests/role-based-redirect.spec.ts >> Role-based redirect after login >> authenticated contractor can access /projects
- Location: tests/role-based-redirect.spec.ts:131:3
