...
- Name: tests/role-based-redirect.spec.ts >> Role-based redirect after login >> field_engineer is redirected to /assignments after login
- Location: tests/role-based-redirect.spec.ts:34:3
