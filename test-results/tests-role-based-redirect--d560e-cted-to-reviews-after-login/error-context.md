...
- Name: tests/role-based-redirect.spec.ts >> Role-based redirect after login >> supervisor_engineer is redirected to /reviews after login
- Location: tests/role-based-redirect.spec.ts:50:3
