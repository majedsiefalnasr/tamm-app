...
- Name: tests/role-based-redirect.spec.ts >> Role-based redirect after login >> admin is redirected to /admin/dashboard after login
- Location: tests/role-based-redirect.spec.ts:18:3
